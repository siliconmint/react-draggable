...
class DraggableCore extends external_commonjs_react_commonjs2_react_amd_react_root_React_.Component /*:: <DraggableCoreProps>*/{
  ...
  render() /*: React.Element<any>*/{
    const child = external_commonjs_react_commonjs2_react_amd_react_root_React_.Children.only(this.props.children);

    // Reuse the child provided
    // This makes it flexible to use whatever element is wanted (div, ul, etc)
    return /*#__PURE__*/external_commonjs_react_commonjs2_react_amd_react_root_React_.cloneElement(child, {
